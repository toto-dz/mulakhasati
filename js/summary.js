...
const initPage = async () => {
  ...
  try {
    ...
    console.error(error);
    document.body.innerHTML = `<main class="container mx-auto py-24 text-center"><h1 class="text-4xl font-semibold">تعذر تحميل البيانات</h1><p class="mt-4 text-on-surface-variant">يرجى التأكد من ضبط اتصال Supabase والمحاولة مرة أخرى.</p><a href="summaries.html" class="inline-flex mt-8 px-6 py-3 rounded-xl bg-primary text-on-primary">عودة إلى الملخصات</a></main>`;
    return;
  }
