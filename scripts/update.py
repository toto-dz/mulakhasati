...
old_css = """.no-scrollbar::-webkit-scrollbar { display: none; }
        .no-scrollbar { -ms-overflow-style: none; scrollbar-width: none; }
    </style>"""

new_css = """.no-scrollbar::-webkit-scrollbar { display: none; }
        .no-scrollbar { -ms-overflow-style: none; scrollbar-width: none; }

        /* Custom scrollbar */
        .custom-scrollbar::-webkit-scrollbar { width: 6px; height: 6px; }
        .custom-scrollbar::-webkit-scrollbar-track { background: transparent; }
        .custom-scrollbar::-webkit-scrollbar-thumb { background: rgba(114, 118, 135, 0.2); border-radius: 8px; }
        .custom-scrollbar:hover::-webkit-scrollbar-thumb { background: rgba(0, 80, 203, 0.4); }
        .custom-scrollbar::-webkit-scrollbar-thumb:hover { background: rgba(0, 80, 203, 0.7); }
    </style>"""

old_viewer = """<!-- PDF Canvas Area -->
<div class="flex-1 bg-surface-container-low overflow-y-auto no-scrollbar p-sm md:p-md relative">
...
if old_viewer in content and old_css in content:
    content = content.replace(old_css, new_css).replace(old_viewer, new_viewer)
